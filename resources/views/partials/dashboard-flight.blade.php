                                ...
                                <a disabled class="card-link" style="cursor: default">
                                    ...
                                    <small class="text-muted">
                                        @if(Auth::user()->isFlying->scheduled_bay == null)
                                            ...
                                            @endif
                                        @else
                                            Assigned Bay {{Auth::user()->isFlying->liveBay->bayInfo->terminal ?? null}} {{Auth::user()->isFlying->mapBay->bay}}@if(Auth::user()->isFlying->mapBay->long_name) ({{Auth::user()->isFlying->mapBay->long_name}})@endif on Arrival | If unable, advise GND for alternate bay on first contact
                                        @endif
                                    </small>
                                </a>
                            </div>
